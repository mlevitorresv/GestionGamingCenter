 ...
 * @author Manuel
 */
public class JPanelModificaciónCliente extends javax.swing.JPanel {
     ...
     */
    public JPanelModificaciónCliente() {
        initComponents();
        initMyComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonEnviarDNI = new javax.swing.JButton();
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(18, 342, 126, 0);
        jPanel1.add(jButtonConfirmarDatos, gridBagConstraints);

        jButtonEnviarDNI.setText("ENVIAR DNI");
        jButtonEnviarDNI.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonEnviarDNIActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jPanel1.add(jButtonEnviarDNI, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
    ...
    private void jButtonEnviarDNIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEnviarDNIActionPerformed
        envioDNI();
    }//GEN-LAST:event_jButtonEnviarDNIActionPerformed
    ...
    private void mostrarInfo(){
        if(!negocio.isDNI(jTextFieldDNI.getText())){
            ...
            negocio.modifCliente(datos);
            String text = "DNI: " + jTextFieldDNI.getText() + "\nNombre completo: " + jTextFieldNombre.getText() + "\nTeléfono: " + jTextFieldTelefono.getText() +"\nEmail: " + jTextFieldEmail.getText() + "\nDirección: " + jTextFieldDireccion.getText() + "\nCódigo postal:" + jTextFieldCodigoPostal.getText();
            JOptionPane.showMessageDialog(null, text);
        }
    }
    
    private void envioDNI(){
        if(!negocio.isDNI(jTextFieldDNI.getText()) || !negocio.validarDNI(jTextFieldDNI.getText())){
            JOptionPane.showMessageDialog(null, "El DNI introducido no es correcto");
        }else{
            String[] datos = negocio.encontrarClienteModif(jTextFieldDNI.getText());
            if(datos!=null){
                jTextFieldNombre.setText(datos[1]);
                jTextFieldApellidos.setText(datos[2]);
                jTextFieldTelefono.setText(datos[3]);
                jTextFieldEmail.setText(datos[4]);
                jTextFieldDireccion.setText(datos[5]);
                jTextFieldCodigoPostal.setText(datos[6]);

                //DNI NO ES MODIFICABLE --> INHABILITO EL CAMPO DE DNI
                jTextFieldDNI.setEditable(false);
            }else{
                String txt = "Se produjo un error o el DNI es inexistente";
...
//</editor-fold>
    ...
    private javax.swing.JButton jButtonEnviarDNI;
