...
public class JPanelConsultaCliente extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(7, 12, 0, 223);
        ...
        gridBagConstraints.insets = new java.awt.Insets(18, 240, 144, 223);
    ...
    private void mostrarInfo(){
        if(!negocio.isDNI(jTextFieldDNI.getText())){
            ...
            jTextArea1.setText(negocio.consultaCliente(jTextFieldDNI.getText()));
        }
    }
